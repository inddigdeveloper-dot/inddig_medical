      ...
      <div className="bg-white shadow-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="text-center sm:text-left">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Medical Portal</h1>
            <p className="text-gray-600 mt-1 text-sm sm:text-base">Appointment Management Dashboard</p>
          </div>
          <button onClick={onLogout} className="w-full sm:w-auto text-red-600 hover:text-red-700 font-semibold flex items-center justify-center gap-2 bg-red-50 px-6 py-2.5 rounded-lg border border-red-100 hover:bg-red-100 transition">
            ...
            <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="bg-white p-6 rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-3 mt-8">
                  <button onClick={() => setEditingAppt(null)} className="w-full sm:w-auto px-6 py-2.5 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg font-medium transition">Cancel</button>
                  <button onClick={submitEdit} className="w-full sm:w-auto px-6 py-2.5 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition">Save Changes</button>
                </div>
              </div>
            </div>
          )}
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                        <div className="flex-1 space-y-3">
                          <div className="flex items-start gap-3">
                            ...
                            <p className="font-semibold text-gray-900 text-lg leading-tight">{apt.client_name}</p>
                          </div>
                          <div className="flex items-center gap-3">
                            <Mail size={18} className="text-gray-500 flex-shrink-0" />
                            <p className="text-gray-700 truncate">{apt.client_email}</p>
                          </div>
                          <div className="flex items-center gap-3">
                          ...
                          <div className="flex items-start sm:items-center gap-3">
                            ...
                            <div className="flex flex-col sm:flex-row sm:gap-2 sm:items-center">
                              ...
                              <p className="text-gray-600 text-sm sm:text-base">{timeStr}</p>
                            </div>
                          </div>
                        </div>
